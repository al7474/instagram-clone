...
const Home: React.FC<{ user: string }> = ({ user }) => {
  ...
  <div className="flex-1 relative min-w-0">
        <main className={`pt-8 px-2 flex justify-center`}>
          ...
          >
            {/* Columna 1: historias y posts (responsive: full width at <=650px, max-w at >650px) */}
            <div
              className={`flex flex-col items-center ${isMobileWidth ? 'w-full max-w-full' : 'max-w-[630px]'} min-w-0`}
            >
              {/* Stories */}
              <div
